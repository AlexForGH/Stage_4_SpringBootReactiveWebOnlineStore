...
## *EN*
#### Link to the previous project based on the Spring Boot and blocking technology stack: https://github.com/AlexForGH/Stage_3_SpringBootWebOnlineStore.git
#### Link to the following project based on the Spring Boot and reactive technology stack with RESTful API, Open API and Spring Data Redis: https://github.com/AlexForGH/Stage_5_SpringBootReactiveWebOnlineStoreWithRESTfulAPIOpenAPIAndRedis.git
...
## *RU*
#### Ссылка на предыдущий проект на основе Spring Boot и блокирующего стека технологий: https://github.com/AlexForGH/Stage_3_SpringBootWebOnlineStore.git
#### Ссылка на следующий проект на основе Spring Boot и реактивного стека технологий с RESTful API, Open API и Spring Data Redis: https://github.com/AlexForGH/Stage_5_SpringBootReactiveWebOnlineStoreWithRESTfulAPIOpenAPIAndRedis.git
